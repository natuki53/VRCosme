...
)
{
    public static AdjustmentParams Default { get; } =
        new(1f, 1f, 1f, 0f, 1f, 0f, 0f, 0f, 0f, 0f, 0f, 0f);
...
public static class ImageProcessor
{
    ...
    public static Image<Rgba32> ApplyAdjustments(Image<Rgba32> source, AdjustmentParams p) =>
        PreviewPipeline.RenderPreview(source, p);
