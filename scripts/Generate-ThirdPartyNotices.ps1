...
[void]$sb.AppendLine("THIRD-PARTY NOTICES FOR VRCOSME CLASSIC")
[void]$sb.AppendLine("")
...
[void]$sb.AppendLine("Keep this file with binary distributions (zip/installer) of VRCosme Classic.")
[void]$sb.AppendLine("")
